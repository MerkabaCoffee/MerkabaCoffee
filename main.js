...
const translations = {
    hu: {
        ...
        'impressum-copyright-text': 'A weboldalon megjelenő minden tartalom (szöveg, kép, grafika, logó) a Merkaba Coffee szellemi tulajdona. Minden jog fenntartva. Az oldal tartalmának másolása vagy felhasználása csak előzetes írásbeli engedéllyel lehetséges.',
    ...
    en: {
        ...
        'impressum-copyright-text': 'All content appearing on the website (text, images, graphics, logo) is the intellectual property of Merkaba Coffee. All rights reserved. Copying or using the content of the site is only possible with prior written permission.',
...
const galleries = {
    ...
    mandula: { images: ['assets/gallery/Mandula/1.jpeg', 'assets/gallery/Mandula/2.jpeg', 'assets/gallery/Mandula/5.jpeg', 'assets/gallery/Mandula/7.JPG', 'assets/gallery/Mandula/8.jpeg'], currentIndex: 0 },
